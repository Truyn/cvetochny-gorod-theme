...
function cg_buyer_memo_html($context = 'site') {
    ...
    <div class="cg-buyer-memo cg-buyer-memo--<?php echo esc_attr($context); ?>">
        ...
        <div class="cg-buyer-memo__grid">
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>После передачи возврат товара надлежащего качества возможен в установленный законом срок при сохранении <b>товарного вида и потребительских свойств</b>.</li>
                    <li>Если письменная информация о порядке и сроках возврата не была предоставлена при доставке, предусмотренный законом срок отказа от товара надлежащего качества может увеличиваться.</li>
        ...
        <div class="cg-buyer-memo__claim">
            ...
            <p><b>E-mail:</b> <?php echo esc_html($contacts['email']); ?> · <b>Телефон:</b> <?php echo esc_html($contacts['phone']); ?> · <b>Адрес для обращений:</b> <?php echo esc_html($contacts['address']); ?></p>
        </div>
...
function cg_buyer_memo_plain_text() {
    ...
    $lines = [
        ...
        '- После передачи возврат товара надлежащего качества возможен в предусмотренный законом срок при сохранении товарного вида и потребительских свойств.',
        '- Если письменную информацию о порядке и сроках возврата не предоставили при доставке, предусмотренный законом срок отказа может увеличиваться.',
        ...
        'Адрес для обращений: ' . $contacts['address'],
    ];
