...
<form name="checkout" method="post" class="checkout woocommerce-checkout cg-classic-checkout" action="<?php echo esc_url(wc_get_checkout_url()); ?>" enctype="multipart/form-data" aria-label="Оформление заказа">
    <div class="cg-classic-checkout__main">
        <section class="cg-checkout-card cg-checkout-card--recipient cg-checkout-card--combined">
            <div class="cg-checkout-card__heading">
                <span>1</span>
                <div>
                    <small>Все данные для доставки букета</small>
                    <h2>Получатель, адрес и пожелания</h2>
                </div>
            </div>

            <div class="cg-checkout-combined">
                <section class="cg-checkout-combined__section" aria-labelledby="cg-checkout-recipient-title">
                    <div class="cg-checkout-subheading">
                        <span>Получатель и адрес</span>
                        <h3 id="cg-checkout-recipient-title">Кому и куда доставить</h3>
                        <p>Укажите контакты получателя, населённый пункт и точный адрес.</p>
                    </div>
                ...
                <section class="cg-checkout-combined__section cg-checkout-combined__section--details" aria-labelledby="cg-checkout-details-title">
                    <div class="cg-checkout-subheading">
                        <span>Дата и пожелания</span>
                        <h3 id="cg-checkout-details-title">Когда доставить и что учесть</h3>
                        <p>Выберите удобный интервал и добавьте текст для бесплатной открытки.</p>
                    </div>
